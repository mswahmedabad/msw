...
define('THEME_OPTIONS', "simple_business_options");
define('THEME_SLUG', 'simple-business');
define('SALESPAGEURL', 'http://www.nimbusthemes.com/wordpress-themes/simple-business/');
...
define('DEMOURL', 'http://preview.nimbusthemes.com/?theme=simple-business');
...
if (!function_exists('nimbus_setup')):
    ...
    function nimbus_setup() {
       ...
       // Localization
        ...
        add_image_size('nimbus_192_186', 192, 186, true);
