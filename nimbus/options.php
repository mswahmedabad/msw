...
function nimbus_options_to_head() {
    ...
    <style type="text/css"><?php echo "\n"; ?>
        ...
        /* Body */
        body { font:<?php echo $body_style['style']; ?> <?php echo $body_style['size']; ?>/<?php echo $body_style['line']; ?> <?php echo $get_fonts[$body_style['face']]['fam']; ?>; color:<?php echo $body_style['color']; ?>;  text-transform:<?php echo $body_style['fonttrans']; ?>; background-color:#fff; }
        body > .container { background:<?php echo nimbus_get_option('nimbus_content_bg_color'); ?>; border:1px solid <?php echo nimbus_get_option('nimbus_content_border_color'); ?>; }
        .line { background:<?php echo nimbus_get_option('nimbus_content_border_color'); ?>; }
        div.sidebar_widget { border: 1px solid <?php echo nimbus_get_option('nimbus_content_border_color'); ?>; }
        /* Links*/
        ...
        /* Header */
        .fa-socialcircle { background: <?php echo nimbus_get_option('social_media_color'); ?>; }
        .fa-socialcircle:hover { background: <?php echo nimbus_get_option('social_media_hover_color'); ?>; }
        ...
        /* Menu */
        .navbar-default .navbar-nav > li > a, .navbar-default .navbar-nav > li > a:hover, .navbar-default .navbar-nav>.open>a, .navbar-default .navbar-nav>.open>a:hover, .navbar-default .navbar-nav>.open>a:focus, .navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:hover, .navbar-default .navbar-nav>.active>a:focus, .nav>li>a:hover, .nav>li>a:focus, .fallback_cb > ul > li > a, .fallback_cb > ul > li > a:hover { font:<?php echo $nimbus_menu_style['style']; ?> <?php echo $nimbus_menu_style['size']; ?>/<?php echo $nimbus_menu_style['line']; ?> <?php echo $get_fonts[$nimbus_menu_style['face']]['fam']; ?>; color:<?php echo $nimbus_menu_style['color']; ?>;  text-transform:<?php echo $nimbus_menu_style['fonttrans']; ?>; }
        .nav .caret, .navbar-default .navbar-nav>.dropdown>a .caret,.navbar-default .navbar-nav>.dropdown>a .caret, .navbar-default .navbar-nav>.dropdown.active>a .caret, .navbar-default .navbar-nav>.open>a .caret, .navbar-default .navbar-nav>.open>a:hover .caret, .navbar-default .navbar-nav>.open>a:focus .caret, .nav a:hover .caret {  border-top-color: <?php echo $nimbus_menu_style['color']; ?>; border-bottom-color: <?php echo $nimbus_menu_style['color']; ?>; }
        .navbar-default .navbar-nav > li li a, header .fallback_cb > ul > li > ul li a, header .fallback_cb > ul > li > ul li a:hover {  font:<?php echo $nimbus_sub_menu_style['style']; ?> <?php echo $nimbus_sub_menu_style['size']; ?>/<?php echo $nimbus_sub_menu_style['line']; ?> <?php echo $get_fonts[$nimbus_sub_menu_style['face']]['fam']; ?>; color:<?php echo $nimbus_sub_menu_style['color']; ?>;  text-transform:<?php echo $nimbus_sub_menu_style['fonttrans']; ?>; }
        .dropdown-menu>.active>a, .dropdown-menu>.active>a:hover, .dropdown-menu>.active>a:focus { color:<?php echo $nimbus_sub_menu_style['color']; ?>; }
        #menu_row .dropdown-menu { background-color:<?php echo nimbus_get_option('nimbus_content_bg_color'); ?>;  }
        ...
        .dropdown-menu>li>a:hover, .dropdown-menu>li>a:focus, .dropdown-menu>.active>a:hover, .dropdown-menu>.active>a:focus{ background-color:<?php echo nimbus_get_option('nimbus_dd_sub_hover_color'); ?>; }
        ...
        .navbar-default .navbar-nav > li > a:hover, .navbar-default .navbar-nav > li > a:hover .caret, .navbar-default .navbar-nav>.open>a, .navbar-default .navbar-nav>.open>a:hover, .navbar-default .navbar-nav>.open>a:focus, .navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:hover, .navbar-default .navbar-nav>.active>a:focus, .nav>li>a:hover, .nav>li>a:focus, .fallback_cb > ul > li > a:hover { color:<?php echo nimbus_get_option('nimbus_menu_hover_color'); ?>; border-top-color: <?php echo nimbus_get_option('nimbus_menu_hover_color'); ?>!important; border-bottom-color: <?php echo nimbus_get_option('nimbus_menu_hover_color'); ?>!important; }
        .navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:hover, .navbar-default .navbar-nav>.active>a:focus { color:<?php echo nimbus_get_option('nimbus_menu_active_color'); ?>; }
        .dropdown-menu { border-right: 1px solid <?php echo nimbus_get_option('nimbus_content_border_color'); ?>; border-left: 1px solid <?php echo nimbus_get_option('nimbus_content_border_color'); ?>; border-bottom: 1px solid <?php echo nimbus_get_option('nimbus_content_border_color'); ?>; }
        /* Frontpage */
        body > .container .row.content_squeeze.frontpage_featured { background:<?php echo nimbus_get_option('feature_row_color'); ?>; }
        /* Odds n Ends */
        code, pre, var { font-family:<?php echo $get_fonts[$code_style['face']]['fam']; ?>; color:<?php echo $code_style['color']; ?>; }
        blockquote, blockquote p { font:<?php echo $blockquote_style['style']; ?> <?php echo $blockquote_style['size']; ?>/<?php echo $blockquote_style['line']; ?> <?php echo $get_fonts[$blockquote_style['face']]['fam']; ?>; color:<?php echo $blockquote_style['color']; ?>;  text-transform:<?php echo $blockquote_style['fonttrans']; ?>; font-size: <?php echo $blockquote_style['size']; ?>; font-weight: <?php echo $blockquote_style['style']; ?>; line-height: <?php echo $blockquote_style['line']; ?>; }
